const printToast = (tipo, mensagem, pai, tempo = 1000) => {
    ...
    toast.className = `d-flex rounded border justify-content-center border-dark p-3 align-items-center bg-${cor} text-light fw-bold`;
